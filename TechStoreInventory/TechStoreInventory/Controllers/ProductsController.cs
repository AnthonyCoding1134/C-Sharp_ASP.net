...
namespace TechStoreInventory.Controllers
{
    public class ProductsController : Controller
    {
        ...
        //declares a private read-only field thats holds reference to instance of the InventoryContext class — which represents a session with the database.
        private readonly InventoryContext _context;

        public ProductsController(InventoryContext context)
        {
            // _context field is assigned the injected InventoryContext
            _context = context;
        }
